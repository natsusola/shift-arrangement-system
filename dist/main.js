...
const localShortcut = __webpack_require__(22);
const isDev = __webpack_require__(32);
...
module.exports = opts => {
	...
	app.on('ready', () => {
		...
		addExtensionIfInstalled('electron-react-devtools', name => __webpack_require__(2).dirname(/*require.resolve*/(!(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))));
...
const isAccelerator = __webpack_require__(23);
const equals = __webpack_require__(24);
const {toKeyEvent} = __webpack_require__(25);
const _debug = __webpack_require__(26);
